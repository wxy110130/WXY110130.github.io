...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by Infinity🍩 %c 你正在访问 Infinity Home",
  ...
  setTimeout(
    console.warn.bind(console, "%c S013-782 %c 监控模式已打开", "color:white; background-color:#d9534f", "")
  );
}
createtime2();
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://s21.ax1x.com/2024/10/13/pAtFKAO.jpg);
    --darkmode-bg:url(https://s21.ax1x.com/2024/10/13/pAtFKAO.jpg);
    --mobileday-bg: url(https://s21.ax1x.com/2024/10/13/pAtFKAO.jpg);
    --mobilenight-bg: url(https://s21.ax1x.com/2024/10/13/pAtFKAO.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
